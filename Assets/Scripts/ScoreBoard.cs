...
public class ScoreBoard : Singleton<ScoreBoard>
{
    ...
    public List<ScoreLevel> ScoreLevels { get; set; } = new List<ScoreLevel>
    {
        ...
        new ScoreLevel(550, new List<string>(),  new List<string>() { "MixingStation" }, 3),
        new ScoreLevel(750, new List<string>() { "Boeuf cru" },  new List<string>(), 2),
        new ScoreLevel(1000, new List<string>() { "Patate crue" },  new List<string>(), 2),
        new ScoreLevel(1250, new List<string>(),  new List<string>(), 3),
        new ScoreLevel(1500, new List<string>() { "Lait" },  new List<string>(), 3),
